...
@section('content')
  ...
  <div class="row">
        ...
        <div class="card-body">
          ...
          <div class="direct-chat-contacts">
            <ul class="contacts-list">
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="{{ Vite::asset('resources/images/user1-128x128.jpg') }}"
                    alt="User Avatar" />
              ...
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="{{ Vite::asset('resources/images/user7-128x128.jpg') }}"
                    alt="User Avatar" />
              ...
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="{{ Vite::asset('resources/images/user3-128x128.jpg') }}"
                    alt="User Avatar" />
              ...
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="{{ Vite::asset('resources/images/user5-128x128.jpg') }}"
                    alt="User Avatar" />
              ...
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="{{ Vite::asset('resources/images/user6-128x128.jpg') }}"
                    alt="User Avatar" />
              ...
              <li>
                <a href="#">
                  <img class="contacts-list-img" src="{{ Vite::asset('resources/images/user8-128x128.jpg') }}"
                    alt="User Avatar" />
    ...
    <div class="col-lg-5 connectedSortable">
      <div class="card bg-primary bg-gradient border-primary mb-4 text-white">
